...
import type { RxDocument, RxCollection, RxDocumentData, RxDocumentWriteData, UpdateQuery, CRDTEntry, ModifyFunction } from './types/index.js';
export declare const basePrototype: {
    readonly primaryPath: import("./index.js").StringKeys<{
        _deleted: boolean;
        _attachments: {
            [attachmentId: string]: import("./index.js").RxAttachmentData;
        };
        _rev: string;
        _meta: import("./index.js").RxDocumentMeta;
    }> | undefined;
    ...
    toJSON(this: RxDocument, withMetaFields?: boolean): import("./index.js").DeepReadonlyObject<{
        _deleted: boolean;
        _attachments: {
            [attachmentId: string]: import("./index.js").RxAttachmentData;
        };
