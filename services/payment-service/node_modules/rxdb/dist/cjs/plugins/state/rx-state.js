...
var RxStateBase = exports.RxStateBase = /*#__PURE__*/function () {
  ...
  function RxStateBase(prefix, collection) {
    ...
    this.$ = (0, _rxjs.merge)(this._ownEmits$, this.collection.eventBulks$.pipe(
    /**
      ...
      while (!done) {
        ...
        try {
          ...
          for (var index = 0; index < useWrites.length; index++) {
            ...
            var value = writeRow.path === '' ? newState : (0, _index.getProperty)(newState, writeRow.path);
  ...
  _proto.get$ = function get$(path) {
     ...
     */
    return (0, _rxjs.defer)(() => this.$.pipe((0, _rxjs.map)(() => this.get(path)), (0, _rxjs.startWith)(this.get(path)), (0, _rxjs.distinctUntilChanged)(_index.deepEqual))).pipe((0, _rxjs.shareReplay)(_index.RXJS_SHARE_REPLAY_DEFAULTS));
  };
  _proto.get$$ = function get$$(path) {
