...
import { getFromMapOrCreate, nextTick, requestIdlePromise } from "./plugins/utils/index.js";
 ...
 */
export var defaultCacheReplacementPolicyMonad = (tryToKeepMax, _unExecutedLifetime) => (_collection, queryCache) => {
  ...
  var mustUncache = queryCache._map.size - tryToKeepMax;
  if (mustUncache <= 0) {
    return;
  }
