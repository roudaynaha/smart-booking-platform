import { createRevision, clone, randomToken, prepareQuery } from "../../index.js";
/**
      ...
      if (schema.attachments) {
        await Promise.all(docs.map(async doc => {
          ...
          await Promise.all(Object.entries(doc._attachments).map(async ([attachmentId, attachmentMeta]) => {
            var attachmentBlob = await oldStorageInstance.getAttachmentData(docId, attachmentId, attachmentMeta.digest);
