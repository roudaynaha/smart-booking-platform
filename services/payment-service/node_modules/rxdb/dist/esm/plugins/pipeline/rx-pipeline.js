...
import { PROMISE_RESOLVE_VOID, clone, createRevision, ensureNotFalsy, lastOfArray, now } from "../utils/index.js";
...
import { FLAGGED_FUNCTIONS, PIPELINE_FN_PREFIX, blockFlaggedFunctionKey, releaseFlaggedFunctionKey } from "./flagged-functions.js";
export var RxPipeline = /*#__PURE__*/function () {
  ...
  function RxPipeline(identifier, source, destination, handler, batchSize = 100) {
    ...
    this.waitBeforeWriteFn = async () => {
      ...
      if (stack && stack.includes(PIPELINE_FN_PREFIX)) {} else {
