...
import { deepEqual, ensureNotFalsy, flatClone, getFromMapOrThrow, getProperty, RXJS_SHARE_REPLAY_DEFAULTS } from "../../plugins/utils/index.js";
...
var RxLocalDocumentPrototype = {
  ...
  get$(objPath) {
    ...
    return this.$.pipe(map(localDocument => localDocument._data), map(data => getProperty(data, objPath)), distinctUntilChanged(deepEqual));
  },
  get$$(objPath) {
