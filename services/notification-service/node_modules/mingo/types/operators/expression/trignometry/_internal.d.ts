 ...
 */
export declare function processOperator(obj: AnyObject, expr: Any, options: Options, fn: Callback<number, number>, fixedPoints?: Record<string, null | number | Error>): number | null;
