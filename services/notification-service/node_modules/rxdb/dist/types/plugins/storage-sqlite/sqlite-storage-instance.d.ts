import { RxJsonSchema, RxStorageInstanceCreationParams, RxStorageInstance, EventBulk, RxStorageChangeEvent, RxDocumentData, BulkWriteRow, RxStorageBulkWriteResponse, RxStorageQueryResult, StringKeys, RxStorageDefaultCheckpoint, RxStorageCountResult, PreparedQuery } from '../../index.js';
import { BehaviorSubject, Observable } from 'rxjs';
import type { RxStorageSQLiteTrial } from './index.js';
...
export declare class RxStorageInstanceSQLite<RxDocType> implements RxStorageInstance<RxDocType, SQLiteInternals, SQLiteInstanceCreationOptions, RxStorageDefaultCheckpoint> {
    ...
    all(db: any, queryWithParams: SQLiteQueryWithParams): Promise<import("./sqlite-types.js").SQLResultRow[]>;
    /**
