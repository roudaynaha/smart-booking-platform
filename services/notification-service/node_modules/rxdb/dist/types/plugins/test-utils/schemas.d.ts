...
export declare const primaryHumanLiteral: import("../../index.js").DeepReadonlyObject<{
...
export declare const humanNormalizeSchema1Literal: import("../../index.js").DeepReadonlyObject<{
    readonly title: "human schema";
    readonly version: 0;
    readonly keyCompression: false;
    readonly description: "describes a human being";
...
export declare const humanCompositePrimarySchemaLiteral: import("../../index.js").DeepReadonlyObject<{
    readonly title: "human schema";
    readonly description: "describes a human being";
    readonly version: 0;
    readonly keyCompression: false;
