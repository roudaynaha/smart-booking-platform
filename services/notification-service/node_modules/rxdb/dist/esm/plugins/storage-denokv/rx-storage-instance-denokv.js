...
import { batchArray, toArray } from "../utils/utils-array.js";
...
import { promiseWait } from "../utils/utils-promise.js";
...
export var RxStorageInstanceDenoKV = /*#__PURE__*/function () {
  ...
  _proto.count = async function count(preparedQuery) {
     ...
     */
    var result = await this.retryUntilNoWriteInBetween(() => queryDenoKV(this, preparedQuery));
    return {
